...
$site_query = "SELECT site_id, site_url, site_name, entry_date FROM Sites WHERE YEAR(entry_date) = $lastyear OR YEAR(entry_date) = $currentyear  ORDER BY entry_date DESC";
...
while($site_array = mysql_fetch_row($site_result))
{
	...
	echo "<tr align=\"left\"><td><a target=\"_blank\" href=\"$site_array[1]\"><b>$site_array[2]</b></a></td>";
