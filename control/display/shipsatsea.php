...
<HEAD>
<TITLE>Guide to Sailing and Cruising Stories - Ships at Sea</TITLE>
...
<tr>
<td>
<h3><i>Currently Updated Logs from Ships at Sea:</i></h3><p>
</tr>
</td>
</table>
...
$site_query = "SELECT site_id, site_url, site_name, site_comment FROM Sites WHERE site_atsea = \"TRUE\" ORDER BY site_rating";
...
while($site_array = mysql_fetch_row($site_result))
{
	...
	echo "<tr align=left valign=center><td><a  href=\"http://cruisenews.net/control/edit_record2.php?edit_line=$site_array[0]\"><b>$site_array[2]</b></a> :: <a  href=\"http://cruisenews.net/control/edit_record2noifr.php?edit_line=$site_array[0]\"><i>no inline frame</i></a></td>";
	echo "<td>$owner_array[0]  $owner_array[1]</td>";
	echo "<td><i>$site_array[3]</i></td>";
	echo "<td>$area_array[0]</td></tr>\n";
}
