	...
	*/
	...
	while($site_cat_array = mysql_fetch_row($site_cat_result))
	{
		...
		*/
		...
		{
			echo "<tr valign=top><td width=\"40%\" align=left><a  href=\"http://cruisenews.net/control/edit_record2.php?edit_line=$site_array[0]\"><b>$site_array[2]</b></a> :: <a  href=\"http://cruisenews.net/control/edit_record2noifr.php?edit_line=$site_array[0]\"><i>no inline frame</i></a>
